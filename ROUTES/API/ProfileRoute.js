...
const {curUserProfile,addExperience,addEducation,addProfile,deleteProfile,modifyProfile,allProfile,profile} = require('../../CONTROLLERS/ProfileCtrl');
...
Router.put("/update/:id",modifyProfile)
Router.get("/me",authenticate,curUserProfile)
Router.put("/addedu/:id",[[
...
],authenticate],addEducation);
Router.put("/addexperience/:id",[[
